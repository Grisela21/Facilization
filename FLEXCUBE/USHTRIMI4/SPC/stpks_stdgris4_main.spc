CREATE OR REPLACE PACKAGE  stpks_stdgris4_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdgris4_main.spc
  **
...
TYPE ty_tb_v_sttms_grisela_detail4 IS TABLE OF sttm_grisela_detail4%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdgris4 IS RECORD (
     v_sttms_grisela_ushtrimi4     sttm_grisela_ushtrimi4%ROWTYPE,
     v_sttms_grisela_main     sttm_grisela_main%ROWTYPE,
     v_sttms_grisela_detail4    ty_tb_v_sttms_grisela_detail4,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdgris4_main FOR stpks_stdgris4_main
/