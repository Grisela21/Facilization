CREATE OR REPLACE PACKAGE  stpks_stdgris4_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdgris4_custom.spc
  **
...
/
CREATE OR REPLACE SYNONYM stpkss_stdgris4_custom FOR stpks_stdgris4_custom
/