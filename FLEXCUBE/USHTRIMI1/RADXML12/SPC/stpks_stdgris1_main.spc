CREATE OR REPLACE PACKAGE  stpks_stdgris1_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdgris1_main.spc
  **
  ** Module     : ST
  ** 
...
TYPE ty_stdgris1 IS RECORD (
     v_sttms_grisela_ushtrimi1     sttm_grisela_ushtrimi1%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdgris1_main FOR stpks_stdgris1_main
/